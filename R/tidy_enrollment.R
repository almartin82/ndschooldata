...
tidy_enr <- function(df) {
  ...
  # Demographic subgroups to tidy (if available)
  demo_cols <- c(
  ...
  # Note: For North Dakota, demographic columns are typically NA
...
#'
#' Adds boolean flags to identify state and district level records.
#'
