...
Fetch and analyze North Dakota school enrollment data from the North
Dakota Department of Public Instruction in R or Python.
...
![North Dakota statewide enrollment
trends](https://almartin82.github.io/ndschooldata/articles/enrollment_hooks_files/figure-html/statewide-chart-1.png)
...
- **Demographics:** Limited (not in main file; available via
  insights.nd.gov)
